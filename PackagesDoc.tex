...
\section{AL.sty}
Le package \Verb?Matrices.sty? sera importé automatiquement avec \Verb?AL.sty?.
...
\footnotetext{Le \Verb?\matgl? de \Verb?AL.sty? correspond à celui de \Verb?Matrices.sty? qui a été renommé}
\mcmd{\gl{E}}
...
\mcmd{\xdots}
\mcmd{\tmatrix({1\&0\\0\&1\\})}
\subsection{\textbackslash tmatrix}
