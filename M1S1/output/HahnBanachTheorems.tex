...
\hypersetup{pdftitle=Analyse anancée -- Hahn-Banach theorems}
\title{Analyse anancée\\\emph{Hahn-Banach theorems}}
\author{}
\date{}
\begin{document}
\begin{frame}
    \titlepage
\end{frame}
\slideq{Analytic Hahn-Banach theorems for functionals in $\mathbb K=\mathbb R$ or $\mathbb K=\mathbb C$}{1/5}
\slider{If $p\!:\!X\to\mathbb R$ is a semi-norm, if $Y$ is a subspace of $X$ and $\phi\!:\!Y\to\mathbb K$ is a functional such that $\left|\phi\right|\leqslant p$ on $Y$ then $\phi$ can be extended to a linear functional on $X$ with its modulus still dominated by $p$}{1/5}
...
\slideq{Structure of complex-valued linear functionals on a TVS $X$}{3/5}
\slider{A linear functional $\phi\!:\!X\to\mathbb C$ is of the form $\psi\l\cdot\r-\ii\psi\l\ii\cdot\r$ for $\psi\!:\!X\to\mathbb R$ a linear functional\linebreak Conversely, any function of this form defines a linear functional $X\to\mathbb C$}{3/5}
\slideq{Corollary of Hahn-Banach theorem in $\mathbb K=\mathbb R$ or $\mathbb K=\mathbb C$ on the existence of specific functionals on a TVS $X$}{4/5}
\slider{If $Y$ is a closed subspace and $v\notin Y$ then there exists a functional $\phi\in X^*$ such that $\phi\equiv0$ on $Y$, $\phi\l v\r=d\l v,Y\r>0$ and $\nrm[X^*]\phi=1$\linebreak If $u\in X$, there exists $\phi\in X^*$ such that $\nrm[X^*]\phi=1$ and $\phi\l u\r=\nrm[X]u$\linebreak$J\!:\!u\mapsto\operatorname{ev}_u$ is a isometry on its image}{4/5}
