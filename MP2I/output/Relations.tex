...
\begin{frame}
    \titlepage
\end{frame}
\slideq{Réflexivité}{1/11}
\slider{$x\R x$}{1/11}
\slideq{Relation d'ordre large}{2/11}
\slider{ Réflexive, antisymétrique et transitive\linebreak Notée $\leqslant$ ou $\geqslant$}{2/11}
...
\slideq{La relation d'équivalence $\R$ est une congruence sur $\l E,\times_1,\cdots,\times_n\r$}{4/11}
\slider{$\forall\l x,x^\prime,y,y^\prime\r\in E^4,\;\forall i\in\llb1,n\rrb\linebreak\l x\R x^\prime\r\wedge\l y\R y^\prime\r\Rightarrow\l x\times_iy\r\R\l x^\prime\times_iy^\prime\r$}{4/11}
\slideq{Asymétrie}{5/11}
\slider{$\l x\R y\r\Rightarrow\neg\l y\R x\r$}{5/11}
\slideq{Antisymétrie}{6/11}
\slider{$\l x\R y\r\wedge\l y\R x\r\Rightarrow\l x=y\r$}{6/11}
\slideq{Symétrie}{7/11}
\slider{$x\R y\Rightarrow y\R x$}{7/11}
\slideq{Irréflixivité ou antiréfléxivité}{8/11}
\slider{$\neg\l x\R x\r$}{8/11}
...
\slideq{Relation d'équivalence}{11/11}
\slider{ Réflexive, symétrique et transitive\linebreak Notée $\equiv$ ou $\sim$}{11/11}
\end{document}