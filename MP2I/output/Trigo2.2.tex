...
\slideq{$\sin{x}\sin{y}$}{20/84}
\slider{$\frac{1}{2}\l\cos{x-y}-\cos{x+y}\r$}{20/84}
\slideq{$\lim{x\to0}{\frac{\ch{x}-1}{x^2}}$}{21/84}
\slider{$\frac{1}{2}$}{21/84}
...
\slideq{$\cos{x}\sin{y}$}{23/84}
\slider{$\frac{1}{2}\l\sin{x+y}-\sin{x-y}\r$}{23/84}
\slideq{Propriétés remarquables de $\asin{x}$}{24/84}
\slider{$\forall x\in\left[-1,1\right],\;\sin{\asin{x}}=x$\linebreak$\forall x\in\left[-\oldfrac{\pi}{2},\oldfrac{\pi}{2}\right],\;\asin{\sin{x}}=x$\linebreak$\forall x\in\left[\oldfrac{\pi}{2},\oldfrac{3\pi}{2}\right],\;\asin{\sin{x}}=\pi-x$}{24/84}
\slideq{$\der{}{\ath{x}}$}{25/84}
\slider{$\frac{1}{1-x^2}$}{25/84}
\slideq{Inégalité classique de $\atan{x}$}{26/84}
\slider{$\forall x\in\R,\;\left|\atan{x}\right|\leqslant\left|x\right|$}{26/84}
\slideq{$\lim{x\to0}{\frac{\tan{x}}{x}}$}{27/84}
\slider{$1$}{27/84}
\slideq{$\cos{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{28/84}
\slider{$\frac{1-t^2}{1+t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{28/84}
\slideq{$\frac{\cot{x}\cot{y}-1}{\cot{x}+\cot{y}}$}{29/84}
\slider{$\cot{x+y}$}{29/84}
\slideq{$\frac{1}{2}\l\sin{x+y}+\sin{x-y}\r$}{30/84}
\slider{$\sin{x}\cos{y}$}{30/84}
\slideq{Valeurs remarquables}{31/84}
...
\slideq{Valeurs remarquables de $\asin{x}$ et $\acos{x}$}{60/84}
...
\slideq{$\cos{2x}$}{67/84}
\slider{$\cos[2]{x}-\sin[2]{x}=2\cos[2]{x}-1=1-2\sin[2]{x}$}{67/84}
\slideq{$\sin{\frac{\pi}{2}-x}$}{68/84}
\slider{$\cos{x}$}{68/84}
\slideq{$\tan{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{69/84}
\slider{$\frac{2t}{1-t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{69/84}
\slideq{Propriétés remarquables de $\atan{x}$}{70/84}
\slider{$\forall x\in\R,\;\tan{\atan{x}}=x$\linebreak$\forall x\in\left]-\oldfrac{\pi}{2},\oldfrac{\pi}{2}\right[,\;\atan{\tan{x}}=x$\linebreak$\forall n\in\N,\;\forall x\in\left]-\oldfrac{\pi}{2}+n\pi,\oldfrac{\pi}{2}+n\pi\right[$\linebreak$\atan{\tan{x}}=x-n\pi$\linebreak$\forall x\in\R^*,\;\atan{x}+\atan{\oldfrac{1}{x}}=\oldfrac{x}{\left|x\right|}\oldfrac{\pi}{2}$}{70/84}
\slideq{$\sin{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{71/84}
\slider{$\frac{2t}{1+t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{71/84}
\slideq{$\sin{x}\cos{y}-\sin{y}\cos{x}$}{72/84}
\slider{$\sin{x-y}$}{72/84}
\slideq{Expression de $\ath{x}$}{73/84}
\slider{$\frac{1}{2}\ln{\frac{1+x}{1-x}}=\ln{\sqrt{\frac{1+x}{1-x}}}$}{73/84}
\slideq{$\der{}{\ach{x}}$}{74/84}
\slider{$\frac{1}{\sqrt{x^2-1}}$}{74/84}
\slideq{$\lim{x\to0}{\frac{\sin{x}}{x}}$}{75/84}
\slider{1}{75/84}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{}{\sh{x}}$}{76/84}
\slider{$\left\{\begin{matrix*}[l]\sh{x}&\;\text{si }n\in2\N\\\ch{x}&\;\text{sinon}\end{matrix*}\right.\!$}{76/84}
\slideq{$\lim{x\to0}{\frac{\sh{x}}{x}}$}{77/84}
\slider{$1$}{77/84}
\slideq{$\cos{x-y}$}{78/84}
\slider{$\cos{x}\cos{y}+\sin{x}\sin{y}$}{78/84}
\slideq{$\der{}{\asin{x}}$}{79/84}
\slider{$\frac{1}{\sqrt{1-x^2}}$}{79/84}
\slideq{$\frac{\cot[2]{x}-1}{2\cot{x}}$}{80/84}
\slider{$\cot{2x}$}{80/84}
\slideq{$\sin{x}\cos{y}+\sin{y}\cos{x}$}{81/84}
\slider{$\sin{x+y}$}{81/84}
\slideq{$\sin{x}-\sin{y}$}{82/84}
\slider{$2\cos{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{82/84}
\slideq{$\frac{1-\cos{2x}}{2}$}{83/84}
\slider{$\sin[2]{x}$}{83/84}
