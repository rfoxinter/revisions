...
\begin{frame}
    \titlepage
\end{frame}
\slideq{$\frac{1-t^2}{2t}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{1/84}
\slider{$\cot{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{1/84}
\slideq{$\sin{x+\pi}$}{2/84}
\slider{$-\sin{x}$}{2/84}
\slideq{$\tan{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{3/84}
...
\slideq{$\sin{\pi-x}$}{5/84}
\slider{$\sin{x}$}{5/84}
\slideq{$\lim{x\to0}{\frac{\atan{x}}{x}}$}{6/84}
\slider{$1$}{6/84}
\slideq{Propriétés remarquables de $\atan{x}$}{7/84}
\slider{$\forall x\in\R,\;\tan{\atan{x}}=x$\linebreak$\forall x\in\left]-\oldfrac{\pi}{2},\oldfrac{\pi}{2}\right[,\;\atan{\tan{x}}=x$\linebreak$\forall n\in\N,\;\forall x\in\left]-\oldfrac{\pi}{2}+n\pi,\oldfrac{\pi}{2}+n\pi\right[$\linebreak$\atan{\tan{x}}=x-n\pi$\linebreak$\forall x\in\R^*,\;\atan{x}+\atan{\oldfrac{1}{x}}=\oldfrac{x}{\left|x\right|}\oldfrac{\pi}{2}$}{7/84}
...
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{}{\ch{x}}$}{60/84}
\slider{$\left\{\begin{matrix*}[l]\ch{x}&\;\text{si }n\in2\N\\\sh{x}&\;\text{sinon}\end{matrix*}\right.\!$}{60/84}
...
\slideq{Propriétés remarquables de $\acos{x}$}{62/84}
\slider{$\forall x\in\left[-1,1\right],\;\cos{\acos{x}}=x$\linebreak$\forall x\in\left[0,\pi\right],\;\acos{\cos{x}}=x$\linebreak$\forall x\in\left[-\pi,0\right],\;\acos{\cos{x}}=-x$}{62/84}
\slideq{$\lim{x\to0}{\frac{\sh{x}}{x}}$}{63/84}
\slider{$1$}{63/84}
\slideq{$\frac{1}{2}\l\cos{x+y}+\cos{x-y}\r$}{64/84}
\slider{$\cos{x}\cos{y}$}{64/84}
\slideq{$\cos[2]{x}-\sin[2]{x}=2\cos[2]{x}-1=1-2\sin[2]{x}$}{65/84}
\slider{$\cos{2x}$}{65/84}
\slideq{$\der{}{\ach{x}}$}{66/84}
\slider{$\frac{1}{\sqrt{x^2-1}}$}{66/84}
\slideq{$2\cos{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{67/84}
\slider{$\sin{x}-\sin{y}$}{67/84}
\slideq{$\lim{x\to0}{\frac{\sin{x}}{x}}$}{68/84}
\slider{1}{68/84}
\slideq{$\lim{x\to0}{\frac{\tan{x}}{x}}$}{69/84}
\slider{$1$}{69/84}
\slideq{$\frac{2\tan{x}}{1-\tan[2]{x}}$}{70/84}
\slider{$\tan{2x}$}{70/84}
\slideq{$\cos{x}+\cos{y}$}{71/84}
\slider{$2\cos{\frac{x+y}{2}}\cos{\frac{x-y}{2}}$}{71/84}
\slideq{$\frac{2t}{1+t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{72/84}
\slider{$\sin{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{72/84}
\slideq{$\lim{x\to0}{\frac{\th{x}}{x}}$}{73/84}
\slider{$1$}{73/84}
\slideq{Courbe représentative de $\ch{x}$}{74/84}
\slider{\begin{tikzpicture} \draw[color=gray,opacity=0.2] (-2.7,-0.2) grid (2.7,5.2); \draw[->] (-2.7, 0) -- (2.7, 0) node[above left]{$x$}; \draw[->] (0,-0.7) -- (0, 5.2) node[below right]{$y$}; \foreach \y in {1,...,5} \draw(0,\y) node[left]{\footnotesize$\y$}; \foreach \x in {-2,-1} \draw(\x,0) node[below]{\footnotesize$\x$}; \foreach \x in {1,2} \draw(\x,0) node[below]{\footnotesize$\x$}; \draw(0,0) node[below left]{\footnotesize$0$}; \draw[domain=-2.333:2.333, samples=500, scale=1, smooth, variable=\x, black] plot (\x,{(exp(\x)+exp(-\x))/2}); \node[above] at (current bounding box.north) {$y=\ch{x}$}; \end{tikzpicture}}{74/84}
\slideq{Inégalité classique de $\atan{x}$}{75/84}
\slider{$\forall x\in\R,\;\left|\atan{x}\right|\leqslant\left|x\right|$}{75/84}
\slideq{$\cos{\frac{\pi}{2}-x}$}{76/84}
\slider{$\sin{x}$}{76/84}
\slideq{$\lim{x\to0}{\frac{\th{x}}{x}}$}{77/84}
\slider{$1$}{77/84}
\slideq{$\lim{x\to0}{\frac{1-\cos{x}}{x^2}}$}{78/84}
\slider{$\frac{1}{2}$}{78/84}
\slideq{Valeurs remarquables de $\asin{x}$ et $\acos{x}$}{79/84}
...
\slideq{Expression de $\ach{x}$}{81/84}
\slider{$\ln{x+\sqrt{x^2-1}}$}{81/84}
\slideq{Valeurs remarquables}{82/84}
