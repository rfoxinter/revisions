...
\slideq{Équation de Maxwell-Ampère}{3/9}
\slider{$\rot\vec B=\mu_0\vec\jmath+\mu_0\varepsilon_0\pder[][t]{\vec E}{}$}{3/9}
\slideq{Équation globale de la conservation de la charge}{4/9}
\slider{$\displaystyle{\iiint_V}\rho\d V+\displaystyle{\varoiint_S}\vec\jmath\cdot\d\vec S=0$}{4/9}
\slideq{Équation de Maxwell-Thomson}{5/9}
\slider{$\rot\vec E=-\pder[][t]{\vec B}{}$}{5/9}
...
\slideq{Équation locale de la conservation de la charge}{8/9}
\slider{$\pder[][t]{\rho}{}+\div\vec\jmath=0$}{8/9}
\slideq{Formule de Stokes}{9/9}
\slider{$\displaystyle{\oint_\varGamma}\vec F\cdot\d\vec l=\displaystyle{\iint_S}\rot\vec F\cdot\d\vec S$}{9/9}
\end{document}