...
\slideq{$\mathcal B\l X\times Y\r$}{2/14}
\slider{$\mathcal B\l X\r\otimes\mathcal{B}\l Y\r$ si $X$ et $Y$ sont à base dénombrable d'ouverts}{2/14}
\slideq{Changement de variable polaire en dimension $>2$}{3/14}
\slider{$\int[x][\mathbb R^d]{f\l x\r}=\altint\iint[][{\mathbb R_+\times\mathbb S^{d-1}}]{f\l ru\r{{}\mathop{r^{d-1}}}\dd r\sigma\l\dd u\r}$\linebreak$\sigma\l A\r=\mu\l\left\{ru,r\in\left[0,1\right],u\in A\right\}\r$, $A\subset\mathbb S^{d-1}$}{3/14}
\slideq{$\l\phi_n\r$ est une approximation de l'unité}{4/14}
\slider{Pour tout $n\in\mathbb N$, $\int[][X]{\phi_n}=1$\linebreak Pour tout $R>0$, $\int[][B\l0,R\r^\complement]{\phi_n}\xrightarrow[n\to+\infty]{}=0$}{4/14}
...
\slideq{Porpriétés de $\phi_n*f$ où $\l\phi_n\r$ est une approximation de l'unité}{6/14}
\slider{Si $f\in\mathcal C^0_b\l\mathbb R^d\r$ alors $\phi_n*f\xrightarrow[n\to+\infty]{\text{CVU}}f$\linebreak Si $f\in L^p\l\mathbb R^d\r$ alors $\phi_n*f\xrightarrow[n\to+\infty]{L^p}f$}{6/14}
\slideq{Porpriétés de $\l f*g\r\l x\r$ pour $f\in L^1\l\mathbb R^d\r$, $g\in\mathcal C^1_b\l\mathbb R^d\r:=\left\{g\in\mathcal C^1\l\mathbb R^d\r,g\in L^\infty,\nabla g\in L^\infty\right\}$}{7/14}
\slider{$f*g\in\mathcal C^1_b\l\mathbb R^d\r$ et $\nabla\l f*g\r=f*\l\nabla f\r$}{7/14}
\slideq{$\mathcal A\otimes\mathcal B$}{8/14}
\slider{$\sigma\l\left\{A\times B,\l A,B\r\in\mathcal A\times\mathcal B\right\}\r$\linebreak C'est la plus petite tribu qui rend les fonctions coordonnées mesurables }{8/14}
...
\slideq{$\l f*g\r\l x\r$\linebreak$\l f,g\r\in L^1\l\mathbb R^d\r$}{12/14}
\slider{$\int[y][\mathbb R^d]{f\l x-y\r g\l y\r}$\linebreak$f*g\in L^1\l\mathbb R^d\r$ et $\lnrm1{f*g}\leqslant\lnrm1f\lnrm1g$}{12/14}
\slideq{Porpriétés de $\l f*g\r\l x\r$ pour $f\in L^p\l\mathbb R^d\r$, $g\in L^{p'}\l\mathbb R^d\r$, $p'=\frac{p}{p-1}$}{13/14}
\slider{$f*g\in L^\infty\l\mathbb R^d\r$ et $\lnrm\infty{f*g}\leqslant\lnrm1f\lnrm1g$\linebreak Si $p\in\left]1,+\infty\right[$ alors $f*g$ est uniformément continue}{13/14}
\slideq{Densité des fonctions $\mathcal C^\infty_c\l\mathbb R^d\r$ dans $L^p$}{14/14}
\slider{Si $p\in\left[1,+\infty\right[$ alors $\mathcal C^\infty_c\l\mathbb R^d\r$ est dense dans $L^p\l\mathbb R^d\r$}{14/14}
\end{document}