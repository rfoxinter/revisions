...
\begin{frame}
    \titlepage
\end{frame}
\slideq{Propriétés de $E$ si $E^*$ est séparable}{1/6}
\slider{Si $E$ est un Banach et $E^*$ est séparable alors $E$ l'est\linebreak En particulier, si $E$ est séparable et réflexif alors $E^*$ est séparable}{1/6}
\slideq{Morphisme canonique $E\to E^{**}$}{2/6}
\slider{$\nappl{E}{E^{**}}{x}{\l\altappl{\delta_x}{E^*}{\mathbb{R}}{f}{f\l x\r}\r}$\linebreak Cette application est une isométrie}{2/6}
\slideq{Espace reflexif}{3/6}
\slider{Un espace de Banach est réflexif si l'application $\nappl{E}{E^{**}}{x}{\l\altappl{\delta_x}{E^*}{\mathbb{R}}{f}{f\l x\r}\r}$ est un isomorphisme}{3/6}
\slideq{Théorème de représentation de Riesz}{4/6}
\slider{Si $\mu\in E^*$ alors in existe un unique $y\in E$ tel que $\mu=\psc y\bullet$}{4/6}
\slideq{Théorème de Hahn-Banach}{5/6}
