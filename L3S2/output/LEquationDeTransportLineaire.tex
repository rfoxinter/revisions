...
\slideq{Solution de $\partd tu+c\partd xu=f$, $u\l0,x\r=u_0\l x\r\in\mathcal C^1\l\mathbb R\r$, $c\in\mathbb R$, $f\in\mathcal C^1\l\mathbb R_+\times\mathbb R\r$}{4/7}
\slider{Si $u_0\in\mathcal C^1\l\mathbb R\r$ alors l'équation possède une unique solution dans $\mathcal C^1\l\mathbb R_+\times\mathbb R\r$ définie par $u\l x,t\r=u_0\l x-ct\r+\int[\tau][0][t]{f\l\tau,x-c\l t-\tau\r\r}$}{4/7}
\slideq{Solution de $\partd tu+c\partd xu=0$, $u\l0,x\r=u_0\l x\r\in\mathcal C^1\l\mathbb R\r$, $c\in\mathbb R$}{5/7}
\slider{Si $u_0\in\mathcal C^1\l\mathbb R\r$ alors l'équation possède une unique solution dans $\mathcal C^1\l\mathbb R_+\times\mathbb R\r$ définie par $u\l x,t\r=u_0\l x-ct\r$}{5/7}
...
\slideq{CNS pour avoir $u\in L^1_\loc\l\Omega\r$ nulle sur $\Omega$ un ouvert}{7/7}
\slider{$\forall\phi\in\mathcal C^\infty_0\l\Omega\r$, $\int[t][\Omega]{u\l t\r\phi\l t\r}=0$}{7/7}
\end{document}