...
\slideq{Extension normale\linebreak Définition par les $\kk$-morphismes}{2/4}
\slider{$\ll/\kk$ est normale si et seulement si $\sigma\l\ll\r=\ll$ pour tout $\sigma\in\gal{\kk^\text{a}}\kk$\linebreak De manière équivalente, $\ll/\kk$ est normale si pour tout $\kk$-plongement $\ll\hookrightarrow\kk^\text{a}$, $\sigma\l\ll\r=\ll$}{2/4}
...
\slideq{Extension normale\linebreak Définition par les $\kk$-conjugués}{4/4}
\slider{$\ll/\kk$ est normale si et seulement si pour tout $x\in\ll$ et tout $\sigma\in\gal{\kk^\text{a}}\kk$, $\sigma\l x\r\in\ll$}{4/4}
\end{document}