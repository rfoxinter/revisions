...
\slideq{Propriété de $A/I$}{2/6}
\slider{Si $A$ est noethérien et $I\vartriangleleft A$ alors $A/I$ est noethérien}{2/6}
\slideq{Propriétés des algèbres de type fini pour $A$ noethérien}{3/6}
\slider{Une sous-algèbre de type fini d'un anneau noethérien est noethérien}{3/6}
\slideq{Théorème de la base de Hilbert}{4/6}
\slider{Si $A$ est noethérien alors $A\left[X_1,\cdots,X_n\right]$ est noethérien}{4/6}
\slideq{Algèbre de type fini}{5/6}
\slider{$B$ est une $A$-algèbre de type fini s'il existe $\l b_1,\cdots,b_n\r\in B^n$ tel que pour tout $b\in B$, il existe $P\in A\left[X_1,\cdots,X_n\right]$ tel que $b=P\l b_1,\cdots,b_n\r$}{5/6}
