...
\begin{frame}
    \titlepage
\end{frame}
\slideq{$\legendre ap\bmod p$}{1/4}
\slider{$\cgr{\legendre ap}{a^{\frac{p-1}2}}p$}{1/4}
\slideq{Inégalité de Pólya--Vinogradov}{2/4}
\slider{Pour tout $a\in\bbZ$, $n\geqslant1$ et $p$ premier impair, $\left|\sum{j=a}{a+n}{\legendre jp}\right|\leqslant\sqrt p\ln p$}{2/4}
