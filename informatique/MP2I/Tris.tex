...
\end{minted}
\info{}{Tri le tableau \mintinline{c}|tab| avec un tri rapide}{\Th{n \log n} (en moyenne), \Th{n^2} (dans le pire des cas)}
\end{imp*}
\begin{imp*}{Tri fusion}
\begin{minted}{c}
...
\end{minted}
\info{}{Tri le tableau \mintinline{c}|tab| avec un tri fusion}{\Th{n \log n}}
\end{imp*}
\ocaml
...
\end{minted}
\info{'a list -> 'a list}{Tri le tableau avec un tri sélection}{\Th{n^2}}
\end{imp*}
\begin{imp*}{Tri insertion}
\begin{minted}{ocaml}
...
\end{minted}
\info{'a list -> 'a list}{Tri le tableau avec un tri insertion}{\Th{n^2}}
\end{imp*}
\begin{imp*}{Tri bulle}
\begin{minted}{ocaml}
...
\end{minted}
\info{'a list -> 'a list}{Tri le tableau avec un tri bulle}{\Th{n^2}}
\end{imp*}
...
\end{minted}
\info{'a list -> 'a list}{Tri le tableau avec un tri rapide}{\Th{n \log n} (en moyenne), \Th{n^2} (dans le pire des cas)}
\end{imp*}