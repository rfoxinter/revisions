...
Structure de données qui permet de stocker un sous-ensemble $\mathcal{N}$ fini de $\mathbb{N}$ (de la forme $\left[\!\left[1,n-1\right]\!\right]$), et d'effectuer des opérations sur celle-ci en \Th{1}.
\end{df*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\c
\begin{tp*}{}
