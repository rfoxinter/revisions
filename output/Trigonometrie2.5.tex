...
\slideq{Argument d'un nombre complexe $z$ avec $\atan{x}$}{73/84}
\slider{$\arg\l z\r\equiv\atan{\frac{\Im\l z\r}{\Re\l z\r}}\,\left[\pi\right]$}{73/84}
\slideq{$\frac{\cot[2]{x}-1}{2\cot{x}}$}{74/84}
\slider{$\cot{2x}$}{74/84}
