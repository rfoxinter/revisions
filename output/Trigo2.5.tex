...
\begin{frame}
    \titlepage
\end{frame}
\slideq{$\lim{x\to0}{\frac{\tan{x}}{x}}$}{1/84}
\slider{$1$}{1/84}
\slideq{Inégalité classique de $\atan{x}$}{2/84}
\slider{$\forall x\in\R,\;\left|\atan{x}\right|\leqslant\left|x\right|$}{2/84}
\slideq{$\cos{x}\cos{y}$}{3/84}
\slider{$\frac{1}{2}\l\cos{x+y}+\cos{x-y}\r$}{3/84}
...
\slideq{$\frac{1-t^2}{2t}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{17/84}
\slider{$\cot{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{17/84}
\slideq{$\sin[2]{x}$}{18/84}
\slider{$\frac{1-\cos{2x}}{2}$}{18/84}
\slideq{$\cos{x}-\cos{y}$}{19/84}
\slider{$-2\sin{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{19/84}
\slideq{$\cos{\frac{\pi}{2}-x}$}{20/84}
\slider{$\sin{x}$}{20/84}
\slideq{$\cos{x}+\cos{y}$}{21/84}
\slider{$2\cos{\frac{x+y}{2}}\cos{\frac{x-y}{2}}$}{21/84}
\slideq{$\sin{x+y}$}{22/84}
\slider{$\sin{x}\cos{y}+\sin{y}\cos{x}$}{22/84}
\slideq{$\frac{2t}{1-t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{23/84}
\slider{$\tan{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{23/84}
...
\slideq{$\lim{x\to-\infty}{\th{x}}$}{25/84}
\slider{$-1$}{25/84}
...
\slideq{$\lim{x\to0}{\frac{1-\cos{x}}{x^2}}$}{28/84}
\slider{$\frac{1}{2}$}{28/84}
\slideq{Courbe représentative de $\ash{x}$}{29/84}
\slider{\begin{tikzpicture} \draw[color=gray,opacity=0.2] (-5.2,-2.7) grid (5.2,2.7); \draw[->] (-5.2, 0) -- (5.2, 0) node[above left]{$x$}; \draw[->] (0,-2.7) -- (0, 2.7) node[below right]{$y$}; \foreach \y in {-2,-1,1,2} \draw(0,\y) node[left]{\footnotesize$\y$}; \foreach \x in {-5,...,-1} \draw(\x,0) node[below]{\footnotesize$\x$}; \foreach \x in {1,...,5} \draw(\x,0) node[below]{\footnotesize$\x$}; \draw(0,0) node[below left]{\footnotesize$0$}; \draw[domain=0:5.2, samples=600, scale=1, smooth, variable=\x, black] plot (\x,{ln(\x+sqrt(\x*\x+1))}); \draw[domain=0:5.2, samples=600, scale=1, smooth, variable=\x, black] plot (-\x,{-ln(\x+sqrt(\x*\x+1))}); \node[above] at (current bounding box.north) {$y=\ash{x}$}; \end{tikzpicture}}{29/84}
\slideq{$\sin{x+\frac{\pi}{2}}$}{30/84}
\slider{$\cos{x}$}{30/84}
\slideq{Inégalités classiques de $\sin{x}$}{31/84}
\slider{$\forall x\in\R_+,\;\sin{x}\leqslant x$\linebreak$\forall x\in\R_-,\;\sin{x}\geqslant x$\linebreak$\forall x\in\R,\;\left|\sin{x}\right|\leqslant\left|x\right|$\linebreak$\forall x\in\left[0,\oldfrac{\pi}{2}\right],\;\sin{x}\geqslant\oldfrac{2x}{\pi}$}{31/84}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{}{\sin{x}}$}{32/84}
\slider{$\sin{x+\frac{n\pi}{2}}=\left\{\begin{matrix*}[l]\l-1\r^{\left\lfloor\oldfrac{n}{2}\right\rfloor}\sin{x}&\;\text{si }n\in2\N\\\l-1\r^{\left\lfloor\oldfrac{n}{2}\right\rfloor}\cos{x}&\;\text{sinon}\end{matrix*}\right.\!$}{32/84}
\slideq{$\der{}{\acos{x}}$}{33/84}
\slider{$-\frac{1}{\sqrt{1-x^2}}$}{33/84}
\slideq{Expression de $\ath{x}$}{34/84}
...
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{}{\sh{x}}$}{36/84}
\slider{$\left\{\begin{matrix*}[l]\sh{x}&\;\text{si }n\in2\N\\\ch{x}&\;\text{sinon}\end{matrix*}\right.\!$}{36/84}
\slideq{$\sin{\pi-x}$}{37/84}
\slider{$\sin{x}$}{37/84}
\slideq{$\cos{\pi-x}$}{38/84}
\slider{$-\cos{x}$}{38/84}
\slideq{$\cos{x}\cos{y}+\sin{x}\sin{y}$}{39/84}
\slider{$\cos{x-y}$}{39/84}
\slideq{Inégalités classiques de $\sh{x}$}{40/84}
\slider{$\forall x\in\R_+,\;\sh{x}\geqslant x$\linebreak$\forall x\in\R_-,\;\sh{x}\leqslant x$}{40/84}
\slideq{$\lim{x\to0}{\frac{\asin{x}}{x}}$}{41/84}
\slider{$1$}{41/84}
\slideq{$\frac{\tan{x}+\tan{y}}{1-\tan{x}\tan{y}}$}{42/84}
\slider{$\tan{x+y}$}{42/84}
...
\slideq{Valeurs remarquables de $\asin{x}$ et $\acos{x}$}{44/84}
\slider{\setcolrow{6}{3}\begin{tikzpicture}[ampersand replacement=\&] \matrix (mat) [table] {  \&$0$\&$\oldfrac{1}{2}$\&$\oldfrac{\sqrt{2}}{2}$\&$\oldfrac{\sqrt{3}}{2}$\&$1$\\ \begin{turn}{45}$\arcsin$\end{turn}\&$0$\&$\oldfrac{\pi}{6}$\&$\oldfrac{\pi}{4}$\&$\oldfrac{\pi}{3}$\&$\oldfrac{\pi}{2}$\\ \begin{turn}{45}$\arccos$\end{turn}\&$\oldfrac{\pi}{2}$\&$\oldfrac{\pi}{3}$\&$\oldfrac{\pi}{4}$\&$\oldfrac{\pi}{6}$\&$0$\\ }; \draw [line width=0.5mm] (-10cm/3,-6.5cm/2) -- (-10cm/3,6.5cm/2); \draw [line width=0.5mm] (-10cm/2,6.5cm/6) -- (10cm/2,6.5cm/6); \draw [line width=0.5mm] (-5cm,-3.25cm) rectangle (5cm,3.25cm); \end{tikzpicture}}{44/84}
\slideq{$\lim{x\to0}{\frac{\atan{x}}{x}}$}{45/84}
\slider{$1$}{45/84}
\slideq{$\sin{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{46/84}
\slider{$\frac{2t}{1+t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{46/84}
\slideq{$\der{}{\ath{x}}$}{47/84}
\slider{$\frac{1}{1-x^2}$}{47/84}
\slideq{$2\sin{x}\cos{x}$}{48/84}
\slider{$\sin{2x}$}{48/84}
\slideq{$\lim{x\to0}{\frac{\sh{x}}{x}}$}{49/84}
\slider{$1$}{49/84}
\slideq{$\sin{x}-\sin{y}$}{50/84}
\slider{$2\cos{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{50/84}
\slideq{$\frac{-\cot{x}\cot{y}-1}{\cot{x}-\cot{y}}=\frac{\cot{x}\cot{y}+1}{\cot{y}-\cot{x}}$}{51/84}
\slider{$\cot{x-y}$}{51/84}
\slideq{$\cos{x+\pi}$}{52/84}
\slider{$-\cos{x}$}{52/84}
\slideq{$\lim{x\to+\infty}{\th{x}}$}{53/84}
\slider{$1$}{53/84}
\slideq{$\der{}{\tan{x}}$}{54/84}
\slider{$\frac{1}{\cos[2]{x}}=1+\tan[2]{x}$}{54/84}
\slideq{Valeurs remarquables}{55/84}
...
\slideq{$\frac{2\tan{x}}{1-\tan[2]{x}}$}{58/84}
\slider{$\tan{2x}$}{58/84}
\slideq{$\lim{x\to0}{\frac{\ch{x}-1}{x^2}}$}{59/84}
\slider{$\frac{1}{2}$}{59/84}
\slideq{Expression de $\ach{x}$}{60/84}
\slider{$\ln{x+\sqrt{x^2-1}}$}{60/84}
\slideq{Expression de $\ash{x}$}{61/84}
...
\slideq{$\cot{x+y}$}{67/84}
\slider{$\frac{\cot{x}\cot{y}-1}{\cot{x}+\cot{y}}$}{67/84}
