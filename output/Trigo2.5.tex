...
\begin{frame}
    \titlepage
\end{frame}
\slideq{$\cos{x}\sin{y}$}{1/84}
\slider{$\frac{1}{2}\l\sin{x+y}-\sin{x-y}\r$}{1/84}
\slideq{$\der{\tan{x}}$}{2/84}
\slider{$\frac{1}{\cos[2]{x}}=1+\tan[2]{x}$}{2/84}
\slideq{$\lim{x\to0}{\frac{\sh{x}}{x}}$}{3/84}
\slider{$1$}{3/84}
\slideq{$\sin{x}\cos{y}+\sin{y}\cos{x}$}{4/84}
\slider{$\sin{x+y}$}{4/84}
\slideq{$\cot{2x}$}{5/84}
\slider{$\frac{\cot[2]{x}-1}{2\cot{x}}$}{5/84}
\slideq{Expression de $\ash{x}$}{6/84}
\slider{$\ln{x+\sqrt{x^2+1}}$}{6/84}
\slideq{$\lim{x\to0}{\frac{\atan{x}}{x}}$}{7/84}
\slider{$1$}{7/84}
\slideq{$\lim{x\to+\infty}{\th{x}}$}{8/84}
\slider{$1$}{8/84}
\slideq{Expression de $\ath{x}$}{9/84}
\slider{$\frac{1}{2}\ln{\frac{1+x}{1-x}}=\ln{\sqrt{\frac{1+x}{1-x}}}$}{9/84}
\slideq{$\frac{1-\cos{2x}}{2}$}{10/84}
\slider{$\sin[2]{x}$}{10/84}
\slideq{$2\cos{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{11/84}
\slider{$\sin{x}-\sin{y}$}{11/84}
\slideq{$\lim{x\to0}{\frac{\th{x}}{x}}$}{12/84}
\slider{$1$}{12/84}
\slideq{$\sin{x-y}$}{13/84}
\slider{$\sin{x}\cos{y}-\sin{y}\cos{x}$}{13/84}
\slideq{$\sin{\frac{\pi}{2}-x}$}{14/84}
\slider{$\cos{x}$}{14/84}
...
\slideq{$\tan{x}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{17/84}
\slider{$\frac{2t}{1-t^2}$\linebreak\linebreak$t=\tan{\frac{x}{2}}$}{17/84}
...
\slideq{$\der{\acos{x}}$}{20/84}
\slider{$-\frac{1}{\sqrt{1-x^2}}$}{20/84}
\slideq{$\frac{\tan{x}-\tan{y}}{1+\tan{x}\tan{y}}$}{21/84}
\slider{$\tan{x-y}$}{21/84}
\slideq{Valeurs remarquables de $\asin{x}$ et $\acos{x}$}{22/84}
\slider{\setcolrow{6}{3}\begin{tikzpicture}[ampersand replacement=\&] \matrix (mat) [table] {  \&$0$\&$\oldfrac{1}{2}$\&$\oldfrac{\sqrt{2}}{2}$\&$\oldfrac{\sqrt{3}}{2}$\&$1$\\ \begin{turn}{45}$\arcsin$\end{turn}\&$0$\&$\oldfrac{\pi}{6}$\&$\oldfrac{\pi}{4}$\&$\oldfrac{\pi}{3}$\&$\oldfrac{\pi}{2}$\\ \begin{turn}{45}$\arccos$\end{turn}\&$\oldfrac{\pi}{2}$\&$\oldfrac{\pi}{3}$\&$\oldfrac{\pi}{4}$\&$\oldfrac{\pi}{6}$\&$0$\\ }; \draw [line width=0.5mm] (-10cm/3,-6.5cm/2) -- (-10cm/3,6.5cm/2); \draw [line width=0.5mm] (-10cm/2,6.5cm/6) -- (10cm/2,6.5cm/6); \draw [line width=0.5mm] (-5cm,-3.25cm) rectangle (5cm,3.25cm); \end{tikzpicture}}{22/84}
\slideq{$2\cos{\frac{x+y}{2}}\cos{\frac{x-y}{2}}$}{23/84}
\slider{$\cos{x}+\cos{y}$}{23/84}
\slideq{$\lim{x\to0}{\frac{\th{x}}{x}}$}{24/84}
\slider{$1$}{24/84}
\slideq{$\sin{x}\sin{y}$}{25/84}
\slider{$\frac{1}{2}\l\cos{x-y}-\cos{x+y}\r$}{25/84}
\slideq{$\cos{\pi-x}$}{26/84}
\slider{$-\cos{x}$}{26/84}
\slideq{$\frac{1+\cos{2x}}{2}$}{27/84}
\slider{$\cos[2]{x}$}{27/84}
\slideq{Propriété remarquable de $\acos{x}$ et $\asin{x}$}{28/84}
\slider{$\acos{x}+\asin{x}=\frac{\pi}{2}$}{28/84}
\slideq{$\lim{x\to0}{\frac{\sin{x}}{x}}$}{29/84}
\slider{1}{29/84}
...
\slideq{$\cos{x-y}$}{39/84}
\slider{$\cos{x}\cos{y}+\sin{x}\sin{y}$}{39/84}
\slideq{Inégalités classiques de $\tan{x}$}{40/84}
\slider{$\forall x\in\left[0,\oldfrac{\pi}{2}\right[,\;\tan{x}\leqslant x$\linebreak$\forall x\in\left]\oldfrac{\pi}{2},0\right],\;\tan{x}\geqslant x$\linebreak$\forall x\in\left]-\oldfrac{\pi}{2},\oldfrac{\pi}{2}\right[,\;\left|\tan{x}\right|\geqslant\left|x\right|$}{40/84}
\slideq{$\sin{x+\frac{\pi}{2}}$}{41/84}
\slider{$\cos{x}$}{41/84}
...
\slideq{$\tan{2x}$}{45/84}
\slider{$\frac{2\tan{x}}{1-\tan[2]{x}}$}{45/84}
\slideq{$\der{\th{x}}$}{46/84}
\slider{$1-\th[2]{x}=\frac{1}{\ch[2]{x}}$}{46/84}
\slideq{$\cos{x+\pi}$}{47/84}
\slider{$-\cos{x}$}{47/84}
\slideq{$\cos{x+y}$}{48/84}
\slider{$\cos{x}\cos{y}-\sin{x}\sin{y}$}{48/84}
\slideq{Expression de $\ach{x}$}{49/84}
\slider{$\ln{x+\sqrt{x^2-1}}$}{49/84}
...
\slideq{$\cos[2]{x}-\sin[2]{x}=2\cos[2]{x}-1=1-2\sin[2]{x}$}{58/84}
\slider{$\cos{2x}$}{58/84}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{\sin{x}}$}{59/84}
\slider{$\sin{x+\frac{n\pi}{2}}=\left\{\begin{matrix*}[l]\l-1\r^{\left\lfloor\oldfrac{n}{2}\right\rfloor}\sin{x}&\;\text{si }n\in2\N\\\l-1\r^{\left\lfloor\oldfrac{n}{2}\right\rfloor}\cos{x}&\;\text{sinon}\end{matrix*}\right.\!$}{59/84}
\slideq{$\der{\ash{x}}$}{60/84}
\slider{$\frac{1}{\sqrt{x^2+1}}$}{60/84}
\slideq{$\frac{1}{2}\l\sin{x+y}+\sin{x-y}\r$}{61/84}
\slider{$\sin{x}\cos{y}$}{61/84}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{\ch{x}}$}{62/84}
\slider{$\left\{\begin{matrix*}[l]\ch{x}&\;\text{si }n\in2\N\\\sh{x}&\;\text{sinon}\end{matrix*}\right.\!$}{62/84}
...
\slideq{Propriétés remarquables de $\asin{x}$}{64/84}
\slider{$\forall x\in\left[-1,1\right],\;\sin{\asin{x}}=x$\linebreak$\forall x\in\left[-\oldfrac{\pi}{2},\oldfrac{\pi}{2}\right],\;\asin{\sin{x}}=x$\linebreak$\forall x\in\left[\oldfrac{\pi}{2},\oldfrac{3\pi}{2}\right],\;\asin{\sin{x}}=\pi-x$}{64/84}
\slideq{$2\sin{\frac{x+y}{2}}\cos{\frac{x-y}{2}}$}{65/84}
\slider{$\sin{x}+\sin{y}$}{65/84}
\slideq{Courbe représentative de $\ash{x}$}{66/84}
\slider{\begin{tikzpicture} \draw[color=gray,opacity=0.2] (-5.2,-2.7) grid (5.2,2.7); \draw[->] (-5.2, 0) -- (5.2, 0) node[above left]{$x$}; \draw[->] (0,-2.7) -- (0, 2.7) node[below right]{$y$}; \foreach \y in {-2,-1,1,2} \draw(0,\y) node[left]{\footnotesize$\y$}; \foreach \x in {-5,...,-1} \draw(\x,0) node[below]{\footnotesize$\x$}; \foreach \x in {1,...,5} \draw(\x,0) node[below]{\footnotesize$\x$}; \draw(0,0) node[below left]{\footnotesize$0$}; \draw[domain=0:5.2, samples=600, scale=1, smooth, variable=\x, black] plot (\x,{ln(\x+sqrt(\x*\x+1))}); \draw[domain=0:5.2, samples=600, scale=1, smooth, variable=\x, black] plot (-\x,{-ln(\x+sqrt(\x*\x+1))}); \node[above] at (current bounding box.north) {$y=\ash{x}$}; \end{tikzpicture}}{66/84}
\slideq{$\der{\asin{x}}$}{67/84}
\slider{$\frac{1}{\sqrt{1-x^2}}$}{67/84}
\slideq{$\cos{\frac{\pi}{2}-x}$}{68/84}
\slider{$\sin{x}$}{68/84}
\slideq{$\cot{x-y}$}{69/84}
\slider{$\frac{-\cot{x}\cot{y}-1}{\cot{x}-\cot{y}}=\frac{\cot{x}\cot{y}+1}{\cot{y}-\cot{x}}$}{69/84}
\slideq{$\der{\atan{x}}$}{70/84}
\slider{$\frac{1}{1+x^2}$}{70/84}
\slideq{$\sin{x+\pi}$}{71/84}
\slider{$-\sin{x}$}{71/84}
\slideq{$\tan{x+y}$}{72/84}
\slider{$\frac{\tan{x}+\tan{y}}{1-\tan{x}\tan{y}}$}{72/84}
\slideq{$\lim{x\to0}{\frac{\asin{x}}{x}}$}{73/84}
\slider{$1$}{73/84}
\slideq{$\lim{x\to-\infty}{\th{x}}$}{74/84}
\slider{$-1$}{74/84}
\slideq{$\sin{\pi-x}$}{75/84}
\slider{$\sin{x}$}{75/84}
\slideq{$\cot{x+y}$}{76/84}
\slider{$\frac{\cot{x}\cot{y}-1}{\cot{x}+\cot{y}}$}{76/84}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{\sh{x}}$}{77/84}
\slider{$\left\{\begin{matrix*}[l]\sh{x}&\;\text{si }n\in2\N\\\ch{x}&\;\text{sinon}\end{matrix*}\right.\!$}{77/84}
