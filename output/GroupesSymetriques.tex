...
\slider{$\l-1\r^{n-c(\sigma)}$\linebreak$c\l\sigma\r$ correspond au nombre de parts dans le support cyclique de $\sigma$}{1/8}
\slideq{$\mathfrak A_n$}{2/8}
\slider{$\ker{\eps}$}{2/8}
\slideq{Inversion}{3/8}
\slider{$\left\{\l i,j\r,\;i<j\wedge\sig i>\sig j\right\}$}{3/8}
\slideq{$\eps\l\sigma\r$\linebreak Expression avec les inversions}{4/8}
\slider{$\l-1\r^{\left|\inv\l\sigma\r\right|}$}{4/8}
\slideq{$\mathfrak S_n$}{5/8}
\slider{Permutations de $\llb1,n\rrb$}{5/8}
