...
\begin{frame}
    \titlepage
\end{frame}
\slideq{$n\in\N^*$, $x\in\R$\linebreak$\der[n]{\sh{x}}$}{1/84}
\slider{$\left\{\begin{matrix*}[l]\sh{x}&\;\text{si }n\in2\N\\\ch{x}&\;\text{sinon}\end{matrix*}\right.\!$}{1/84}
\slideq{$\ach{x}$}{2/84}
\slider{$\ln{x+\sqrt{x^2-1}}$}{2/84}
\slideq{$\lim{x\to0}{\frac{\ch{x}-1}{x^2}}$}{3/84}
\slider{$\frac{1}{2}$}{3/84}
\slideq{$\cos{2x}$}{4/84}
\slider{$\cos[2]{x}-\sin[2]{x}=2\cos[2]{x}-1=1-2\sin[2]{x}$}{4/84}
\slideq{Inégalités classiques de $\sin{x}$}{5/84}
\slider{$\forall x\in\R_+,\;\sin{x}\leqslant x$\linebreak$\forall x\in\R_-,\;\sin{x}\geqslant x$\linebreak$\forall x\in\R,\;\left|\sin{x}\right|\leqslant\left|x\right|$\linebreak$\forall x\in\left[0,\oldfrac{\pi}{2}\right],\;\sin{x}\geqslant\oldfrac{2x}{\pi}$}{5/84}
\slideq{Inégalités classiques de $\tan{x}$}{6/84}
\slider{$\forall x\in\left[0,\oldfrac{\pi}{2}\right[,\;\tan{x}\leqslant x$\linebreak$\forall x\in\left]\oldfrac{\pi}{2},0\right],\;\tan{x}\geqslant x$\linebreak$\forall x\in\left]-\oldfrac{\pi}{2};\oldfrac{\pi}{2}\right[,\;\left|\tan{x}\right|\geqslant\left|x\right|$}{6/84}
...
\slider{$2\cos{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{21/84}
\slideq{$\sin{\pi-x}$}{22/84}
\slider{$\sin{x}$}{22/84}
\slideq{$\der{\th{x}}$}{23/84}
\slider{$1-\th[2]{x}=\frac{1}{\ch[2]{x}}$}{23/84}
\slideq{$\lim{x\to+\infty}{\th{x}}$}{24/84}
\slider{$1$}{24/84}
\slideq{$\lim{x\to0}{\frac{1-\cos{x}}{x^2}}$}{25/84}
\slider{$\frac{1}{2}$}{25/84}
\slideq{$\lim{x\to0}{\frac{\th{x}}{x}}$}{26/84}
\slider{$1$}{26/84}
\slideq{$\sin{x}+\sin{y}$}{27/84}
\slider{$2\sin{\frac{x+y}{2}}\cos{\frac{x-y}{2}}$}{27/84}
...
\slideq{Argument d'un nombre complexe $z$ avec $\atan{x}$}{75/84}
\slider{$\arg\l z\r\equiv\atan{\frac{\Im\l z\r}{\Re\l z\r}}\,\left[\pi\right]$}{75/84}
\slideq{$\cos{\frac{\pi}{2}-x}$}{76/84}
\slider{$\sin{x}$}{76/84}
\slideq{$\lim{x\to0}{\frac{\sin{x}}{x}}$}{77/84}
\slider{1}{77/84}
\slideq{$\lim{x\to0}{\frac{\tan{x}}{x}}$}{78/84}
\slider{$1$}{78/84}
\slideq{$\frac{1-\cos{2x}}{2}$}{79/84}
\slider{$\sin[2]{x}$}{79/84}
\slideq{$\frac{-\cot{x}\cot{y}-1}{\cot{x}-\cot{y}}=\frac{\cot{x}\cot{y}+1}{\cot{y}-\cot{x}}$}{80/84}
\slider{$\cot{x-y}$}{80/84}
\slideq{$\cot{x+y}$}{81/84}
\slider{$\frac{\cot{x}\cot{y}-1}{\cot{x}+\cot{y}}$}{81/84}
\slideq{$\sin{x}\cos{y}+\sin{y}\cos{x}$}{82/84}
\slider{$\sin{x+y}$}{82/84}
\slideq{$\frac{1+\cos{2x}}{2}$}{83/84}
\slider{$\cos[2]{x}$}{83/84}
\slideq{$\cos{x}-\cos{y}$}{84/84}
\slider{$-2\sin{\frac{x+y}{2}}\sin{\frac{x-y}{2}}$}{84/84}
\end{document}