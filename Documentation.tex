...
\vspace{0.5cm}
\mhd
\nmcmd{\makebigop[p]{symb}}{Produit un opérateur avec le symbole \texttt{symb} et ajuste sa taille pour qu'elle soit de $p$ fois celle du caractère $\oldsum$}
