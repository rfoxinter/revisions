...
\footnotetext{Comme \hyperlink{section.6}{\texttt{BigOperators.sty}} est chargé, la commande \Verb?\sum? est remplacée et il est nécessaire de taper \Verb?\oldsum? pour obtenir $\oldsum$}
\mcmd{\oldesc}
