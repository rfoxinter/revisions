...
\usepackage{output/matrices,output/al,output/analyse,output/arithmetique,output/arrows,output/complexes,output/equivalents,output/galois,output/hats,output/polynomes,output/probas,output/sffont,output/structures,output/trigo,output/tables,output/topologie,output/usuelles}
\makeatletter
...
Pour utiliser des commandes avec des parenthèses automatiques (comme pour $\oldsup$), il est possible de placer dans le préambule\footnote{Cette commande est déjà définie dans \hyperlink{section.23}{\texttt{Usuelles.sty}}}:
...
\footnotetext{Ne pas confondre cette commande avec \mintinline{latexmath}?\mat? de \hyperlink{section.14}{\texttt{Matrices.sty}}}
...
Le package \hyperlink{section.20}{\texttt{Tools.sty}} sera importé automatiquement avec \texttt{Analyse.sty}.
...
Le package \hyperlink{section.20}{\texttt{Tools.sty}} sera importé automatiquement avec \texttt{BigOperators.sty}.
...
Le package \hyperlink{section.20}{\texttt{Tools.sty}} sera importé automatiquement avec \texttt{Matrices.sty}.
...
Le package \hyperlink{section.20}{\texttt{Tools.sty}} sera importé automatiquement avec \texttt{Usuelles.sty}.
