...
\footnotetext{Correspond à la commande usuelle \mintinline{latexmath}?\partial?\\Il est possible de rétablir le symbole italique $\slantpartial$ pour les commandes avec le symbole $\partial$ en utilisant \mintinline{latex}?\let\partial\slantpartial? après l'import de ce package}
