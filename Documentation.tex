...
\let\oldoplus\oplus
\usepackage{output/sffont,output/htmlpreambule,output/matrices,output/al,output/bigoperators,output/analyse,output/arithmetique,output/complexes,output/dsft,output/equivalents,output/polynomes,output/probas,output/structures,output/trigo,output/tables,output/usuelles}
\makeatletter
...
Ce package utilise le package \texttt{graphics} (disponible sur \href{https://ctan.org/pkg/graphics}{CTAN}).
...
\subsection{\boldmath Les commandes avec $\mcdot$}
