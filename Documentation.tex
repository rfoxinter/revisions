...
Il est sinon possible de mettre un lien vers un fichier téléchargé et hébergé sur un serveur (encodé en base64 et sans les << \texttt{=} >> finaux) en ajoutant \texttt{?card=nom\_du\_fichier}.
