...
\usepackage{output/sffont,output/matrices,output/al,output/arithmetique,output/dsft,output/equivalents,output/polynomes,output/probas,output/structures,output/trigo,output/tables,output/usuelles}
...
\mcmd{\oldepi}
\mcmd{\epi{f}}
\subsection{L'option {\color{namecolour}\texttt{nopar}}}
