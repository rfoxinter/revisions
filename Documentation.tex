...
\end{Verbatim}
\Verb?\l? et \Verb?\r? sont définis dans \hyperlink{section.i}{Preambule.sty et HTMLPreambule.sty}.
\tableofcontents
\null\newpage
...
Par exemple, avec 2pt, on obtient : \setlength{\dotsep}{2pt} $\xdots$.\setlength{\dotsep}{5.5pt}
