...
La commande \mintinline{latex}?$\sup{\left\{x\in\mathbb{Q}\;\sq\;x^2<2\right\}}$? donne donc\linebreak$\sup{\left\{x\in\mathbb{Q}\;\sq\;x^2<2\right\}}$.
...
\footnotetext{Le \mintinline{latexmath}?\matgl? de \Verb?AL.sty? correspond à la commande \mintinline{latexmath}?\gl? de \hyperlink{section.10}{\Verb?Matrices.sty?} qui a été renommé}
\mcmd{\gl{E}}
...
\footnotetext{Ne pas confondre cette commande avec \mintinline{latexmath}?\mat? de \hyperlink{section.10}{\Verb?Matrices.sty?}}
...
\footnotetext{On peut appliquer les mêmes arguments optionnels que pour \mintinline{latexmath}?\der?}
