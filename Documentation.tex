...
\footnotetext{\boldmath Les caractères \Verb?\&? sont utilisés au lieu du \Verb?&? utilisé habituellement avec \tikzlg{} pour des raisons de compatibilité avec \href{https://ctan.org/pkg/beamer}{\color{black}\textsc{beamer}}}
\subsection{Ne pas importer les commandes avec $\mcdot$}
...
Il est également possible de faire de même avec la hauteur des $\mdots$ en modifiant la longueur \Verb?\dotlift?.
